        ...
        <main class="main-bg">
            <div class="row p-5">
                <div class="col-lg-7 m-auto">
                    <h1 class="text-center text-white index-text animation-text text-primary text-pop-up-top">Welcome to ELibrary</h1>
                </div>
                <div class="col-lg-5 " >
                    <div class="contact-form my-5 p-3">
                        <form action="welcome.php" method="POST" class="my-form">
                            ...
                            <div class="form-group">
                                <a href="SignUp.php" class="btn btn-success form-control ani-button">Create Account</a>
                            </div>
                        </form>
                    </div>
                </div>
